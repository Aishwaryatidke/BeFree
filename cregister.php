...
<form   method="post" action="db/cregdb.php">
    <table>
    ...
    <tr>
            <td>Company Name</td>
           <td> <input type="text" name="cName" value="" placeholder="Enter Company Name" required/></td>
    </tr>
<tr>
        <td>Type</td>
    ...
    <tr>
        <td>Password</td>
        <td><input type="text" name="Password" size="15" maxlength="10" pattern="(?=.*\d)(?=.*[A-Z)(?=.*[a-z]).{8,}" title="must contain atleast one number and ane uppercase and lowercase letter" placeholder="Enter Password" reuired/></td>
    </tr>
	<tr>
        <td>Re-Password</td>
