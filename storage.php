          ...
          <div class="container">
            <div class="navbar-header">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                <li class="active"><a href="tprofile.html">Home</a></li>
...
<form   method="POST" action="storagesubmit.php">
    <table>
    <center> <img src="11.jpg " class="p1"></center>
    <h1>Fill Storage Details</h1>


	<tr>
        <td> Available Sanitary pads </td>
       <td> <input type="text" name="avapads" value="" placeholder="Available Sanitary pads" required/></td>
    </tr>
    
<tr>
        <td> School name </td>
       <td> <input type="text" name="sName" value="" placeholder="School name" required/></td>
    </tr>
...
<br><BR><br>
 ...
 <div class="container">
   <button onclick="storagesubmit.php" type="button" name="show" class="btn btn-info">Show THe Currently Available Sanitary pads</button>
</div>
