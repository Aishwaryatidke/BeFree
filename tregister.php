...
<form  action="tregdb.php" method="post">
    <table>
	...
	<tr>
        <td> Teacher Name</td>
       <td> <input type="text" name="tName" value="" placeholder="Enter Teacher Name" required/></td>
    </tr>
    <tr>
            <td>School Name</td>
    ...
    <tr>
        <td>Age</td> 
        <td><input type="number" name="Age" value="" pattern=""  placeholder="Enter Age" required/></td>
    </tr>
	 <tr>
        <td>Gender</td>
    ...
    <tr>
        <td>Password</td>
        <td><input type="password" name="Password" size="15" maxlength="10" pattern="(?=.*\d)(?=.*[A-Z)(?=.*[a-z]).{8,}" title="must contain atleast one number and ane uppercase and lowercase letter" placeholder="Enter Password" required/></td>
    </tr>
<tr>
        <td>Re-Password</td>
        <td><input type="password" name="Password2" size="15" maxlength="10" pattern="(?=.*\d)(?=.*[A-Z)(?=.*[a-z]).{8,}" title="must contain atleast one number and ane uppercase and lowercase letter" placeholder="Enter Password" reuired/></td>
    </tr>
<tr>
        <td>Type</td>
