...
<head>
    <meta charset="UTF-8">
    <title>Profile of gynecologist</title>
...
<form  action="gregdb.php" method="post">
    <table>
	...
	<tr>
        <td> Name</td>
       <td> <input type="text" name="Name" value="" placeholder="Enter your Name" required/></td>
    </tr>
   
    <tr>
        <td>Age</td>
        <td><input type="number" name="Age" value="" pattern="" title="contain only number" placeholder="Enter Age" required/></td>
    </tr>
	 <tr>
        <td>Gender</td>
        <td><select id = "myList" name="Gender" required/>
	 ...
	 <tr>
        <td>Contact</td>
                <td><input type="tel" name="Contact" value=""title="contain only number" placeholder="Enter your phone number" required/></td>

    </tr>
    <tr>
	 <td>Clinic Name</td>
                <td><input type="text" name="Clinic" value="" placeholder="Enter your Clinic Name" required/></td>

   </tr>
	<tr>
        <td>Address</td>
                <td><input type="text" name="City" value="" placeholder="City" required/>
				<input type="text" name="Tal" value="" placeholder="Tahshil" required/>
				<input type="text" name="Dist" value="" placeholder="District" required/>
...
<tr>
        <td>Type</td>
        <td><select id = "myList" name="Type" required/>
    ...
    <tr>
        <td>Password</td>
        <td><input type="text" name="Password" size="15" maxlength="10" pattern="(?=.*\d)(?=.*[A-Z)(?=.*[a-z]).{8,}" 
